  ...
  return (
    ...
    <div className={`ekit-template-content-markup ekit-template-content-header ekit-template-content-theme-support${transparent ? ' site-header--overlay' : ''}`}>
      <div data-elementor-type="wp-post" data-elementor-id={3436} className="elementor elementor-3436">
        <div className={`elementor-element elementor-element-346619f e-con-full elementor-hidden-tablet elementor-hidden-mobile e-flex e-con e-parent ${
        isHomePage ? 'desktopheader' : ''
      }`} data-id="346619f" data-element_type="container" data-e-type="container" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
